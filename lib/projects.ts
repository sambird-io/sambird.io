...
export const projects: Project[] = [
  ...
  },
  {
    ...
    tagline:
      "Retrieval-augmented generation built from scratch — and the evals to prove where it fails.",
    year: "2025",
    context: "Solo project",
    stack: [
      "Python",
    ...
    approach:
      "I built a RAG pipeline over the Kubernetes documentation with no frameworks — chunking, embeddings, a ChromaDB vector index, retrieval and Claude-based generation, each as an explicit, inspectable step — then wrote an evaluation suite that scores retrieval and generation separately.",
    result:
    ...
    highlights: [
      "No frameworks — every RAG component is explicit",
  ...
  },
  {
    ...
    approach:
      "I built reusable Terraform modules — Shared VPC, GKE with autoscaling node pools and release channels, project scaffolding and IAM role bindings — and wired them into a per-environment structure delivered through Jenkins running on Kubernetes pod agents.",
    result:
